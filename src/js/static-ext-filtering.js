...
µBlock.staticExtFilteringEngine = (function() {
    ...
    api.compile = function(raw, writer, filterPath) {
        ...
        if ( suffix.charCodeAt(0) === 0x5E /* '^' */ ) {
            µb.htmlFilteringEngine.compile(parsed, writer, filterPath);
            return true;
        }
    ...
    //TODO: Igor 16.02.18 This is a new code. third parameter must be a filterPath
    api.fromCompiledContent = function(reader, options, filterPath) {
        µb.cosmeticFilteringEngine.fromCompiledContent(reader, options, filterPath);
